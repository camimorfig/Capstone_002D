...
DROP TABLE Player_Elite CASCADE CONSTRAINTS;
...
CREATE TABLE Galery_Front (
    ...
    galery_front_description VARCHAR(400),
...
--------------------------------------------------------
  ...
  CREATE TABLE Player_Elite (	    
    PLAYER_ELITE_ID INTEGER GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
    PLAYER_ELITE_RUT VARCHAR(13)NOT NULL,
    PLAYER_ELITE_NAME VARCHAR(50) NOT NULL,
    PLAYER_ELITE_LAST_NAME VARCHAR(50) NOT NULL,
	PLAYER_ELITE_DISCIPLINE VARCHAR2(50) NOT NULL,
    PLAYER_IMG blob,
    player_status VARCHAR(30) NOT NULL,
    player_birthday DATE NOT NULL,
---- IDs ----
    ...
    CONSTRAINT pk_Player_Elite PRIMARY KEY (PLAYER_ELITE_ID)
);


ALTER TABLE Player_Elite     
    ADD CONSTRAINT fk_Player_Elite_Discipline FOREIGN KEY (discipline_id) 
        REFERENCES Discipline(discipline_id);
